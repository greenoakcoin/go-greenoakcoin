...
Please see [Releases](https://github.com/greenoakcoin/go-greenoakcoin/releases). We recommend using the [most recently released version](https://github.com/greenoakcoin/go-greenoakcoin/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/greenoakcoin/go-greenoakcoin/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://github.com/greenoakcoin/go-greenoakcoin/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/greenoakcoin/go-greenoakcoin/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in Ethereum visit [https://bounty.ethereum.org](https://bounty.ethereum.org) or email bounty@ethereum.org. Please read the [disclosure page](https://github.com/greenoakcoin/go-greenoakcoin/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.
