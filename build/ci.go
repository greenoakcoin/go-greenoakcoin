...
import (
	...
	"github.com/greenoakcoin/go-greenoakcoin/crypto/signify"
	"github.com/greenoakcoin/go-greenoakcoin/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/greenoakcoin/go-greenoakcoin/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/greenoakcoin/go-greenoakcoin/mobile")
